...
import { CheckCircle, Clock, Package, Phone, Mail, MapPin, CreditCard, FileText } from 'lucide-react';
...
export default function OrderShow() {
    ...
    return (
        <ShopFrontLayout>
            <Head title={`Order #${order.id} - Rovic Meat Products`} />
                ...
                <div className="max-w-4xl mx-auto px-4">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <span className="text-sm text-gray-900 capitalize">{order.payment_method}</span>
                                        </div>
                                        <div className="flex items-start">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-2 text-sm text-blue-800">
                            ...
                            <p>• Keep this order number for reference: <strong>#{order.id}</strong></p>
                        </div>
                    </div>
