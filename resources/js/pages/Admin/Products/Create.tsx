...
import { ArrowLeft, Package, Upload, FolderOpen, X, Save } from 'lucide-react';
...
function CreateProduct({ categories }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Use post with forceFormData to send multipart/form-data
    post('/admin/products', {
      forceFormData: true,
    });
  };
...
CreateProduct.layout = (page: React.ReactElement) => <AppLayout>{page}</AppLayout>;
